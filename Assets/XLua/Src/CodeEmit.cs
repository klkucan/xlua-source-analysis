...
namespace XLua
{
    public class CodeEmit
    {
        ...
        /// 这IL写的骚断腿啊
        /// </summary>
        /// <param name="toBeWrap"></param>
        /// <returns></returns>
        public Type EmitTypeWrap(Type toBeWrap)
        {
            // 类型创建，可以看到是类名+Wrap+一个数字
            ...
            // 加载第一个参数
            il.Emit(OpCodes.Ldarg_0);
            // 调用ObjectTranslatorPool_FindTranslator
            il.Emit(OpCodes.Call, ObjectTranslatorPool_FindTranslator);
            // 保存返回值translator
            il.Emit(OpCodes.Stloc, translator);
            ...
            //begin obj
            // 本质就是 Utils.BeginObjectRegister(toBeWrap, L, translator, 1, 1, 1, 1, -1);
